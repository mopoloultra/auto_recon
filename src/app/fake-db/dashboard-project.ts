export class ProjectDashboardDb
{
    ...
    public static widgets = {
        ...
        'quoteWidget': {
            'quote': 'All you need is the plan, the road map, and the courage to press onto your destination.',
            'name' : 'Earl Nightingale',
            'section' : 'American Author',
            'url' : 'assets/images/avatars/Blair.jpg'
        },
        'annoucementWidget': {
            'annoucement': 'We have a recon meeting today at 3:00pm. Don\'t be late!.',
            'name' : 'Tim Marshall',
            'section' : 'User Car Manager',
            'time' : '02/11/2020 08:46 am',
            'url' : 'assets/images/avatars/Estes.jpg'
        },
        'pendingWidget':{
            'notifications'   : [
                {
                    msg  : '🔥 16 Hot List Vehicles'
                }
                ,
                {
                    msg  : '✉️ 10 Unread Messages'
                },
                {
                    msg  : '🔔 12 Notifications'
                },
                {
                    msg  : '📋 03 Due Tasks'
                },
                {
                    msg  : '🗓 05 Calender Events'
                }
            ]
        },
        tasksWidget:{
            ...
            tasks : [
                {
                    name:'Technical Management Meeting',
                    tag: 'COMPANY',
                },
                {
                    name:'TKick-off Company CRM Mobile App Development',
                    tag: 'INTERNAL',
                },
                {
                    name:'Hold an Interview for Marketing Manager Position',
                    tag: 'MARKETING',
                },
                {
                    name:'AirAsia Intranet Systems Project Meeting',
                    tag: 'AIRASIA',
                },
                {
                    name:'Technical Management Meeting',
        ...
        activitiesWidget:{
            ...
            tasks : [
                ...
                {
                    name:'Finance report for year 2019 has been released.',
                    tag: '',
                    icon: 'insert_chart_outlined'
                },
                {
                    name:'You have 5 pending memberhsip requests that requires a quick review.',
                    tag: '',
                    icon: 'how_to_reg'
                },
                {
                    name:'New order recieved with  ',
                    tag: 'INTERNAL',
                    highlight: 'REFERENCE NUMBER 345223',
                    icon: 'shopping_basket'
                },
                {
                    name:'Web server hardware needs to be upgraded.',
                    tag: '',
                    icon: 'notifications'
                },
                {
                    name:'IPO report for year 2019 has been released.',
                    tag: '',
                    icon: 'insert_chart_outlined'
                },
                {
                    name:'You have 6 pending tasks',
                    tag: '',
                    icon: 'done'
                }
            ]
        },
        activeCompletedWidget: {
            chartType: 'line',
            datasets : {
                'yesterday': [
                    {
