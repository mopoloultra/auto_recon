...
import { ProcessingDialogComponent } from './board/dialogs/processing-dialog/processing-dialog.component';
import {MatAutocompleteModule, MatProgressSpinnerModule, MatSelectModule} from '@angular/material';
import { AddTaskComponent } from './board/dialogs/add-task/add-task.component';
...
@NgModule({
    ...
    entryComponents: [ScrumboardCardDialogComponent, ProcessingDialogComponent, AddTaskComponent]
})
